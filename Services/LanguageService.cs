...
namespace AhmedRawdiBusinessPlatform.Services
{
    public class LanguageService : ILanguageService
    {
        ...
        private static readonly Dictionary<string, string> EnDict = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "GroupSaveSuccessTitle", "Group Saved" },
            { "GroupSaveSuccessMessage", "Group details and form permissions saved successfully." },
            { "GroupSaveFailedTitle", "Unable to Save Group" },
            { "GroupSaveValidationMessage", "Please enter required fields (Group Code and English Name)." },
            { "Cancel", "Cancel" },
            { "OK", "OK" },
