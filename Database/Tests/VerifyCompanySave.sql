...
BEGIN TRY
    ...
    EXEC dbo.usp_MasterData_Save
        @EntityKey='Companies',
        @ID=NULL,
        @Payload=N'{"Code":"DIAG-CO","EngName":"Diagnostic Company","ArbName":"Diagnostic Company","CRN":"123","VATRN":"456","PhoneNo":"0500000000","Email":"test@example.com","LocationCountryID":1,"AddressEngName":"Address","AddressArbName":"Address","IsActive":true}',
        @RegUserID=1,
